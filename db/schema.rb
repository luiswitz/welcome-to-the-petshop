...
ActiveRecord::Schema.define(version: 20_180_106_174_343) do
  ...
  create_table 'addresses', force: :cascade do |t|
    ...
    t.index %w[addressable_type addressable_id], name: 'index_addresses_on_addressable_type_and_addressable_id', using: :btree
  end
  ...
  create_table 'fae_files', force: :cascade do |t|
    ...
    t.index %w[fileable_type fileable_id], name: 'index_fae_files_on_fileable_type_and_fileable_id', using: :btree
  end
  ...
  create_table 'fae_images', force: :cascade do |t|
    ...
    t.index %w[imageable_type imageable_id], name: 'index_fae_images_on_imageable_type_and_imageable_id', using: :btree
  end
  ...
  create_table 'fae_text_fields', force: :cascade do |t|
    ...
    t.index %w[contentable_type contentable_id], name: 'index_fae_text_fields_on_contentable_type_and_contentable_id', using: :btree
